...
% Parameters.
%
tr_seed = 170644; te_seed = 440617; sg_seed = 170647;         % Seeds.
...
output_dir = 'C:\Users\emili\Documents\!Cours\INFO5\otdm\uo_nn_v40\CSV\'; % Specify the directory where you want to save the CSV file
csvfile = strcat(output_dir, 'uo_nn_batch_',num2str(tr_seed),'-',num2str(te_seed),'-',num2str(sg_seed),'.csv');
